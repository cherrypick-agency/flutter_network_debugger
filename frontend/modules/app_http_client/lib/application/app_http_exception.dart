...
// Copied from original DioException
...
// If backend returned structured error JSON
class AppHttpServerException extends AppHttpException {
  final ServerErrorPayload serverError;

  AppHttpServerException(AppHttpException exception, this.serverError)
      : super(
          requestOptions: exception.requestOptions,
          response: exception.response,
          type: exception.type,
  ...
  ServerErrorCode get code => parseServerErrorCode(serverError.code);
  String get messageFromServer => serverError.message;
}
