...
class _IntegrationsPageState extends State<IntegrationsPage> {
  ...
  // Proxy address for hints/copying
  ...
  Future<void> _loadStatus() async {
    ...
    try {
      ...
      if (mounted)
        setState(() {
          _loading = false;
          _initLoaded = true; // first render after loading statuses
        });
    }
  }
  ...
  // Folder opening function removed - icon hidden
  ...
  Future<void> _autoIntegrate() async {
    ...
    try {
      ...
      await _loadStatus();
      // Auto-polling status after action
                    ...
                    child: Column(
                      ...
                      children: [
                        Wrap(
                          ...
                          children: [
                            /*
                      // Temporarily hide chip with detected OS
                      Tooltip(
                      ...
                      */
                            Tooltip(
                              ...
                              child: Chip(
                                ...
                                backgroundColor: _enabled
                                    ? context.appColors.success.withOpacity(
                                        0.25,
                                      )
                                    : cs.surfaceVariant,
                              ),
                            ...
                            if (!kIsWeb)
                              Tooltip(
                                ...
                                child: Chip(
                                  ...
                                  backgroundColor: _osCAInstalled
                                      ? context.appColors.success.withOpacity(
                                          0.25,
                                        )
                                      : cs.surfaceVariant,
                            ...
                            /*
                      // Temporarily remove helper icons (folder/copying CA fingerprints)
                      if ((_caPath ?? '').isNotEmpty)
                        IconButton(
                                  ...
                                  Wrap(
                                    ...
                                    children: [
                                      ...
                                      OutlinedButton.icon(
                                        ...
                                        label: const Text('Regenerate dev CA'),
                                      ),
                                      if (_lastCAPath != null && !kIsWeb)
                                        TextButton.icon(
                                          onPressed: _loading
                                              ? null
                                              : () => _revealFile(_lastCAPath!),
                                          icon: const Icon(Icons.folder_open),
                                    ...
                                    children: [
                                      ...
                                      TextButton.icon(
                                        onPressed: _loading
                                            ? null
                                            : () {
                                                // Start watching status so you don't have to press Refresh
                                                _pollStatus();
                                                ScaffoldMessenger.of(
                                                  context,
                                                ).showSnackBar(
