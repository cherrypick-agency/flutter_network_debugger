...
func Test_classifyNetError(t *testing.T) {
	...
	cases := map[string]string{
		...
		"server misbehaving":        "DNS_ERROR",
		"x509: cert":                "TLS_ERROR",
		"certificate":               "TLS_ERROR",
		"tls":                       "TLS_ERROR",
		"connection refused":        "SERVER_UNAVAILABLE",
		"reset by peer":             "CONNECTION_RESET",
		"unexpected EOF":            "CONNECTION_CLOSED",
		"before full header":        "CONNECTION_CLOSED",
		"early eof":                 "CONNECTION_CLOSED",
		"request canceled":          "CANCELED",
		"client canceled":           "CANCELED",
		"something else":            "UPSTREAM_ERROR",
	}
